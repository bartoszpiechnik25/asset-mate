import etf_service_pb3.etf_service_pb2 as etf_service_pb3
import etf_service_pb3.etf_service_pb2_grpc as etf_service_pb3_grpc
...
class EtfServiceServicer(etf_service_pb3_grpc.EtfServiceServicer):
    async def GetEtf(self, request, context):
        ...
        return etf_service_pb3.Etf(**data, **spec)
